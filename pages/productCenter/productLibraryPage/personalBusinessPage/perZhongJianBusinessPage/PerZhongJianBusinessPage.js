...
(function (btop) {
    ...
    (function (bui) {
        ...
        var PerZhongJianBusinessPage = (function (_super) {
            __extends(PerZhongJianBusinessPage, _super);
            function PerZhongJianBusinessPage() {
                _super.apply(this, arguments);
                this.menuIds = new Array(); //存放菜单Id容器
                this.menuNames = new Array(); //存放菜单名称容器
                this.isFirstLoad = true; //是否为第一次加载
            }
            PerZhongJianBusinessPage.prototype.initView = function () {
                var _this = this;
                if (this.data["menuId"]) {
            ...
            /***************************************************第一次进入页面，进行初始化显示**********************************************************************/
            PerZhongJianBusinessPage.prototype.initMenuView = function () {
             ...
             */
            PerZhongJianBusinessPage.prototype.requestThirdMenu = function (parentId) {
                var _this = this;
             ...
             */
            PerZhongJianBusinessPage.prototype.initThirdMenu = function (productMenus) {
                var _this = this;
                for (var i in productMenus) {
             ...
             */
            PerZhongJianBusinessPage.prototype.bindEvents = function () {
                var _this = this;
             ...
             */
            PerZhongJianBusinessPage.prototype.initFourthData = function (transferData) {
                var _this = this;
             ...
             */
            PerZhongJianBusinessPage.prototype.requestFourthMenu = function (parentId, parentName) {
                var _this = this;
                var reqMsg = new bui.ReqMsg();
                reqMsg.body = {
                    MENU_ID: parentId
             ...
             * @param productMenus 产品菜单数据
             */
            PerZhongJianBusinessPage.prototype.initFourthMenu = function (productMenus, parentName) {
                var _this = this;
             ...
             */
            PerZhongJianBusinessPage.prototype.destroy = function () {
                var stackpage = WidgetManager.byId("btop.bui.StackPage");
                if (stackpage)
                    stackpage.destroy();
                _super.prototype.destroy.call(this);
            };
            return PerZhongJianBusinessPage;
        })(Page);
        bui.PerZhongJianBusinessPage = PerZhongJianBusinessPage;
    })(bui = btop.bui || (btop.bui = {}));
})(btop || (btop = {}));
//# sourceMappingURL=PerZhongJianBusinessPage.js.map