...
(function (btop) {
    ...
    (function (bui) {
        ...
        var ReXiaoImgPage = (function (_super) {
            __extends(ReXiaoImgPage, _super);
            function ReXiaoImgPage() {
                _super.apply(this, arguments);
            }
            ReXiaoImgPage.prototype.initView = function () {
                //返回销售主页
             ...
             * @param filePath
             */
            ReXiaoImgPage.prototype.loadFile = function (filePath) {
                var callBack = function (data) {
                    document.getElementById("reXiaoFile").src = data["localFilePath"];
                };
                bui.FileService.filterFile(filePath, callBack);
            };
            return ReXiaoImgPage;
        })(Page);
        bui.ReXiaoImgPage = ReXiaoImgPage;
    })(bui = btop.bui || (btop.bui = {}));
})(btop || (btop = {}));
//# sourceMappingURL=ReXiaoImgPage.js.map