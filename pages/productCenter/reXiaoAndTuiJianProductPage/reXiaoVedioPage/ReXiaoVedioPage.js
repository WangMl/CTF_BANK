...
(function (btop) {
    ...
    (function (bui) {
        ...
        var ReXiaoVedioPage = (function (_super) {
            __extends(ReXiaoVedioPage, _super);
            function ReXiaoVedioPage() {
                _super.apply(this, arguments);
            }
            ReXiaoVedioPage.prototype.initView = function () {
                //返回销售主页
             ...
             * @param filePath
             */
            ReXiaoVedioPage.prototype.loadFile = function (filePath) {
                var callBack = function (data) {
                    document.getElementById("reXiaoFile").src = data["localFilePath"];
                };
                bui.FileService.filterFile(filePath, callBack);
            };
            return ReXiaoVedioPage;
        })(Page);
        bui.ReXiaoVedioPage = ReXiaoVedioPage;
    })(bui = btop.bui || (btop.bui = {}));
})(btop || (btop = {}));
//# sourceMappingURL=ReXiaoVedioPage.js.map