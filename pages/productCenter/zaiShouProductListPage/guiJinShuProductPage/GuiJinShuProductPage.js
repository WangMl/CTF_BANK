...
(function (btop) {
    ...
    (function (bui) {
        ...
        var GuiJinShuProductPage = (function (_super) {
            __extends(GuiJinShuProductPage, _super);
            function GuiJinShuProductPage() {
                _super.apply(this, arguments);
            }
            GuiJinShuProductPage.prototype.initView = function () {
                var _this = this;
                //1. 返回产品中心页面，并保持现场数据
                ...
                reqMsg.body = {};
                bui.HttpUtils.bipHttp('product_nobleMetalList', reqMsg).then(function (data) {
                ...
                $('#app').click(function (event) {
                    ...
                    if (event.target.innerHTML === "查看详情") {
                        ...
                        if (PRODUCTCODE) {
                            ...
                            bui.HttpUtils.bipHttp("product_nobleMetalInfo", reqMsg_1).then(function (data) {
                                if (data.header.rc == "0000") {
                                    //console.info(data);
                                    var option = {
                                        top: "10%",
                                    ...
                                    var pageAlert = bui.BGlobal.PageAlert.show("btop.bui.GuiJinShuXiangQingProductPage", data, option);
            ...
            GuiJinShuProductPage.prototype.executeVue = function (data) {
                Vue.component('condition', {
                    template: '#guijinshu-condition-temp',
                    props: ['filterText']
                });
                Vue.component('list', {
                    template: '#guijinshu-list-temp',
                    props: ['items']
                });
                Vue.component('filter-list', {
                    template: '#guijinshu-filter-list-temp',
                    data: function () {
                        return {
                            filterText: '',
                            items: data
            ...
            return GuiJinShuProductPage;
        })(Page);
        bui.GuiJinShuProductPage = GuiJinShuProductPage;
    })(bui = btop.bui || (btop.bui = {}));
})(btop || (btop = {}));
//# sourceMappingURL=GuiJinShuProductPage.js.map