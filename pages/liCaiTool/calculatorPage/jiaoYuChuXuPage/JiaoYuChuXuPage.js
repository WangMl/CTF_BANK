...
(function (btop) {
    ...
    (function (bui) {
        ...
        var JiaoYuChuXuPage = (function (_super) {
            __extends(JiaoYuChuXuPage, _super);
            function JiaoYuChuXuPage() {
                _super.apply(this, arguments);
            }
            JiaoYuChuXuPage.prototype.initView = function () {
                ...
                validatorUtils.validate($("#jiaoYuChuXuPage")[0]);
                //取出存款工具表
                //1 首先取出缓存数据
            ...
            //查找利率
            JiaoYuChuXuPage.prototype.findLilv = function (bizhong, cunqi, type) {
                var typ = { "美元": "14", "欧元": "38", "英镑": "12", "港币": "13", "日元": "27", "澳元": "29", "加元": "28" };
                var ty = { "三个月": "02", "六个月": "03", "一年": "04", "二年": "05", "三年": "06", "六年": "07" };
            ...
            return JiaoYuChuXuPage;
        })(Page);
        bui.JiaoYuChuXuPage = JiaoYuChuXuPage;
...
//# sourceMappingURL=JiaoYuChuXuPage.js.map