...
(function (btop) {
    ...
    (function (bui) {
        ...
        var ZhengCunZhengQuPage = (function (_super) {
            __extends(ZhengCunZhengQuPage, _super);
            function ZhengCunZhengQuPage() {
                _super.apply(this, arguments);
            }
            ZhengCunZhengQuPage.prototype.initView = function () {
                ...
                validatorUtils.validate($("#zhengCunZhengQuPage")[0]);
                //取出存款工具表
                //1 首先取出缓存数据
            ...
            //查找利率
            ZhengCunZhengQuPage.prototype.findLilv = function (bizhong, cunqi, type) {
             ...
             * @returns {string}
             */
            ZhengCunZhengQuPage.prototype.findInrtByTypes = function (dataMode, dpstType) {
                if (this.toolDeposits != null) {
            ...
            return ZhengCunZhengQuPage;
        })(Page);
        bui.ZhengCunZhengQuPage = ZhengCunZhengQuPage;
...
//# sourceMappingURL=ZhengCunZhengQuPage.js.map