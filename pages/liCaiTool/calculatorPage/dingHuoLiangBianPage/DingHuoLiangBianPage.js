...
(function (btop) {
    ...
    (function (bui) {
        ...
        var DingHuoLiangBianPage = (function (_super) {
            __extends(DingHuoLiangBianPage, _super);
            function DingHuoLiangBianPage() {
                _super.apply(this, arguments);
            }
            DingHuoLiangBianPage.prototype.initView = function () {
                ...
                validatorUtils.validate($("#dingHuoLiangBianPage")[0]);
                //取出存款工具表
                //1 首先取出缓存数据
                ...
                //
                //var datepicker:DatePicker = <DatePicker>WidgetManager.byId("datepicker2");
                //datepicker.Date = {year: 2013, month: 1, date: 13};
                //$('#' + datepicker.id).find("input").addClass('input-control');
                var bizhong = null;
                var cunqi = null;
                ...
                $("#compute").click(function (e) {
                    ...
                    var lilv = liLv * 0.6 / 12 / 100;
                    var lixi = benjin * cunqi * lilv;
            ...
            //查找利率
            DingHuoLiangBianPage.prototype.findLilv = function (bizhong, cunqi, type) {
                var typ = { "美元": "14", "欧元": "38", "英镑": "12", "港币": "13", "日元": "27", "澳元": "29", "加元": "28" };
                var ty = { "三个月": "11", "六个月": "12", "一年": "13" };
             ...
             * @returns {string}
             */
            DingHuoLiangBianPage.prototype.findInrtByTypes = function (dataMode, dpstType) {
                if (this.toolDeposits != null) {
            ...
            return DingHuoLiangBianPage;
        })(Page);
        bui.DingHuoLiangBianPage = DingHuoLiangBianPage;
...
//# sourceMappingURL=DingHuoLiangBianPage.js.map