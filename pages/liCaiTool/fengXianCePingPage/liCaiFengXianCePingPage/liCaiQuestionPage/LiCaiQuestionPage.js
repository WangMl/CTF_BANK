...
(function (btop) {
    ...
    (function (bui) {
        ...
        var LiCaiQuestionPage = (function (_super) {
            __extends(LiCaiQuestionPage, _super);
            function LiCaiQuestionPage() {
                _super.apply(this, arguments);
                this.currentQuestions = new Array();
                this.currentQusIndex = 0;
            }
            LiCaiQuestionPage.prototype.initView = function () {
                var _this = this;
                ...
                this.currentQuestions.push($('#question9'));
                this.currentQuestions.push($('#question10'));
                this.currentQuestions.push($('#question11'));
                this.currentQuestions.push($('#question12'));
                ...
                $(".showDown").html("<div class='col l12' style='margin-top: 10px;text-align: center;font-size: 25px'>" + "一共11页，此页为第1页 " + "</div>");
                ...
                $(".next").click(function () {
                    ...
                    $(".showDown").html("<div class='col l12' style='margin-top: 10px;text-align: center;font-size: 25px'>" + "一共11页，此页为第" + index + "页" + "</div>");
                    if (index > 1) {
                ...
                $("#cal").click(function () {
                    ...
                    var total = parseInt($("input[name='No1']:checked").val()) +
                        ...
                        parseInt($("input[name='No9']:checked").val()) +
                        parseInt($("input[name='No10']:checked").val()) +
                        parseInt($("input[name='No11']:checked").val());
                    $(".pre").css("display", "none");
                    $(".submit").css("display", "none");
                    if (total <= 15) {
                        customer = "保守型";
                    ...
                    $(".showDown").css("display", "none");
                    $(".show").html("<div class='col l12' style='margin-top: 10px;text-align: center;font-size: 35px'>" + ""
             ...
             */
            LiCaiQuestionPage.prototype.chooseOnlyAnswer = function () {
                var _this = this;
             ...
             * @description 下一步操作
             */
            LiCaiQuestionPage.prototype.nextQuestion = function () {
             ...
             * @description 上一步操作
             */
            LiCaiQuestionPage.prototype.preQuestion = function () {
             ...
             */
            LiCaiQuestionPage.prototype.submitValidate = function () {
                var _this = this;
            ...
            return LiCaiQuestionPage;
        })(btop.hui.Page);
        bui.LiCaiQuestionPage = LiCaiQuestionPage;
    })(bui = btop.bui || (btop.bui = {}));
})(btop || (btop = {}));
//# sourceMappingURL=LiCaiQuestionPage.js.map